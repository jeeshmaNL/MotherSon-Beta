...
const LevelForm: React.FC = () => {
  ...
  useEffect(() => {
    axios.get<Line[]>('http://127.0.0.1:8000/lines/')
  ...
  return (
    ...
    //   <h2 className="text-2xl font-semibold mb-4">Add Level</h2>
    //   <form onSubmit={handleSubmit} className="space-y-4">
    //     <div>
    //       <label className="block mb-1 font-medium">Select Line</label>
    //       <select
    //         value={selectedLine ?? ''}
  ...
  <div className="bg-white rounded-xl shadow-md p-6 mb-8">
    ...
    <section className="mb-10 p-6 bg-gray-50 rounded-lg">
      <h2 className="text-xl font-semibold text-gray-700 mb-4">Add New Level</h2>
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label htmlFor="line-select" className="block text-sm font-medium text-gray-600 mb-1">
              Select Line <span className="text-red-500">*</span>
            </label>
            <select
              id="line-select"
              value={selectedLine ?? ''}
          ...
          <div>
            <label htmlFor="level-select" className="block text-sm font-medium text-gray-600 mb-1">
