...
export const tiles = [
  ...
  },
  {
    title: 'Snapshots',
    links: [
      { name: 'Monthly', path: '/reports/monthly', icon: FileBarChart2 },
      { name: 'Annual', path: '/reports/annual', icon: FileBarChart2 },
    ],
    icon: Camera,
    statusText: 'Updated',
  ...
  },
  {
    ...
    links: [
      ...
      // { name: 'Retraining', path: '/retrain', icon: RotateCw },
      // { name: '10 Cycle', path: '', icon: AlertCircle },
  ...
  },
  {
    title: 'Schedules',
    links: [
      // { name: 'Monthly', path: '/reports/monthly', icon: Clock },
      // { name: 'Annual', path: '/reports/annual', icon: Calendar },
  ...
  },
  {
    title: 'Settings',
    links: [
      // { name: 'List', path: '/users/list', icon: Sliders },
      // { name: 'Roles', path: '/users/roles', icon: UserCog },
