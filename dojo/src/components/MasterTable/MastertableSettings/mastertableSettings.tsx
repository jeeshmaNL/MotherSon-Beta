...
//                   Operators submitted successfully!
//                 </div>
//               )}
//             </div>
//           </div>
		...
		try {
			...
			if (response.ok) {
				...
				if (notifications.length > 0) {
					...
					if (latestTime > fiveSecondsAgo && latest.notification_type === 'employee_registration') {
						setRecentNotifications(prev => [latest.title, ...prev.slice(0, 2)]);
			...
			{showNotificationAlert && (
				<div className="fixed top-4 right-4 z-50 bg-green-500 text-white px-6 py-4 rounded-lg shadow-lg flex items-center space-x-3 animate-pulse">
					...
					<div>
						...
						<p className="text-sm">Employee registration notification created</p>
					</div>
					<button
                      ...
                      <div className='mt-2 text-sm text-green-700'>
                        ...
                        {uploadResult.success_count > 0 && (
                          <p className="text-green-600 mt-1">
                            📢 Notifications sent to administrators for {uploadResult.success_count} new employee(s)
                          </p>
                        )}
                        {uploadResult.error_count > 0 && (
                          <p>
              ...
              {submitSuccess && (
                <div className='p-4 bg-green-50 text-green-700 rounded-md border border-green-200'>
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <p className="font-semibold">Operators submitted successfully!</p>
                      <p className="text-sm text-green-600">
                        📢 Notifications have been sent to administrators about the new employee registrations.
                      </p>
                    </div>
                  </div>
                </div>
