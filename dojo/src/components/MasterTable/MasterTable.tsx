...
const MasterTable = () => {
    ...
    return (
        <div className="p-5 overflow-x-auto">
            <h1 className="text-2xl font-extrabold mb-4 text-center">Operator Master Table</h1>
            ...
            <div className="flex justify-between mb-4">
                <div className="w-1/2">
                    <input
                        ...
                        className="w-full py-2 px-3 rounded border border-gray-300 bg-white text-sm outline-none shadow-sm hover:border-gray-400 focus:border-blue-500 focus:ring focus:ring-blue-200"
                    />
                </div>
