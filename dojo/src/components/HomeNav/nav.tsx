...
export default function Nav() {
	...
	return (
		<nav className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur border-b border-gray-200 px-6 py-2.5 flex justify-between items-center text-[#001740] z-50">
					...
					{logoLoading ? (
						...
						<>
							...
							<div className="flex flex-col justify-center">
								<span className="text-2xl font-extrabold text-[#0b1f4c] tracking-wide leading-tight">
									MOTHERSON
								</span>
						...
						<div className="flex flex-col justify-center">
							<span className="text-2xl font-bold tracking-tight">MOTHERSON</span>
							<span className="hidden md:inline text-sm font-semibold text-gray-700 tracking-wide mt-1">
			...
			>
				<span className="hidden sm:inline text-blue-900 drop-shadow">
					Dojo 2.0 Training Optimization Platform
				</span>
				<span className="sm:hidden text-blue-900">
					Dojo 2.0
				</span>
			</div>
			...
			<div className="flex items-center gap-3">
				...
				<div className="relative">
					<button
						...
						className="focus:outline-none"
					>
						<div className="w-11 h-11 rounded-full border-2 border-[#001740] flex items-center justify-center bg-gradient-to-br from-[#001740] to-blue-700 text-white font-semibold shadow-md ring-2 ring-blue-200 hover:ring-4 transition-all duration-200">
							{getInitial()}
						</div>
					</button>
					{dropdownOpen && (
						<div className="absolute right-0 mt-3 w-80 bg-white/90 backdrop-blur border border-gray-200 rounded-2xl shadow-2xl z-50 text-[#001740] animate-fadeInUp">
							...
							<div className="flex flex-col items-center px-6 pt-4 pb-3">
								<div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#001740] to-blue-700 text-white flex items-center justify-center font-bold text-2xl shadow-md ring-2 ring-blue-200">
									{getInitial()}
							...
							<div className="px-6 py-2 flex justify-center">
								<button
									onClick={handleLogout}
									className="w-[60%] flex items-center justify-center gap-2 text-sm text-[#001740] bg-white rounded-full py-2 shadow hover:bg-gray-100 transition-all duration-150"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
										className="h-4 w-4"
