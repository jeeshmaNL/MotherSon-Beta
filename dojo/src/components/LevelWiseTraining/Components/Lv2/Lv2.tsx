...
const paperIdMap: Record<string, number> = {
  'Coil Winding': 2,
  'Magnet Wire cutting & stripping':3,
  'Fuse splicing and fuse Assy & Coil winding & Lead wire & Diode':4,
  'Bonding shrink tube & silicon tube cutting':5,
  'Lead wire cutting & stripping':6,
  'Diode lead bending':7,
  'Lead wire & Diode lead Assy':8,
  'Coil winding & Lead wire & Diode lead Assy':9,
  'Coil & Bobbin Assy':10,
  'Housing & Flange Assy assembly with Diode cover, Insulator & Grommet':11,
  'Bobbin,Coil ASM & Housing & flange Assy assembly':12,
  'Epoxy moulding':13,
  'Gauging':14,
  'Wire cutting & stripping':15,
  'Ring terminal crimping':16,
  'IR testing':17,
  'Earth terminal & Housing Assy':18,
  'Housing lead wire & TPS lead wire splicing':19,
  'Shrink tube heating & lead wire length checking':20,
  'Performance testing':21,
  'Final Inspection' : 22,
  'Friction ring  pasting' :23,
  'Pulley machining':24,
  'Bearing pressing & caulking':25,
  'Deflashing (BMC)':26,
  'Hub Riveting':27,
  'Armature Riveting':28,
  'Aluminising Operation':29,
  'Grinding':30,
  'Concavity & flatness inspection':31,
  'PDI':32,
