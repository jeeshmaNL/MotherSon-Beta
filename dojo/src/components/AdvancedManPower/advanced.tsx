...
const Advanced = () => {
	...
	return (
		<>
			<Nav />
			{/* <div className='sm:0 md:0 bg-gray-100'> */}
            <div className="w-full mx-auto flex flex-col px-2 sm:px-4">
				<div className='bg-black mb-4 md:mb-6 mt-5'>
					{/* <h4 className="text-base text-center font-bold uppercase p-2 bg-gradient-to-r from-gray-800 to-gray-900 rounded shadow-md text-white mb-4">
