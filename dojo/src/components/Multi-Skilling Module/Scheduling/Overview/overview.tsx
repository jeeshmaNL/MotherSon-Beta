      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 mb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label htmlFor="status-filter" className="flex items-center text-sm font-semibold text-gray-700">
            ...
            <div className="space-y-2">
              <label htmlFor="date-filter" className="flex items-center text-sm font-semibold text-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="group bg-white p-8 rounded-3xl shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
            ...
            <div className="mt-4 h-2 bg-gray-200 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-purple-500 to-indigo-600 rounded-full" style={{width: '100%'}}></div>
            </div>
          </div>
        </div>
      </div>
