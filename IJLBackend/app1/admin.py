...
from .models import Device, HanContent, HanTrainingContent, KeypadEvent, Level2TrainingContent, LevelTwoOJT, Leveltwodepartments, ShoContent, ShoTrainingContent, SubTopicContent, VoteSession, MultiSkilling
...
class SkillMatrixAdmin(admin.ModelAdmin):
    list_display = ('departments', 'last_updated_on', 'next_updation_date', 'doc_no','Eff_Date','rev_no_date', 'prepared_by', 'approved_by')
    search_fields = ('departments', 'prepared_by', 'approved_by')
    list_filter = ('last_updated_on', 'next_updation_date')

@admin.register(OperationList)
class OperationListAdmin(admin.ModelAdmin):
    list_display = ('name', 'matrix', 'minimum_skill_required',)
    search_fields = ('name',)
    list_filter = ('minimum_skill_required',)
...
admin.site.register(LevelTwoOJT)
admin.site.register(Leveltwodepartments)
