...
from . import views
from .views import (
    ARVRTrainingContentViewSet, AllEmployeesWithActiveSkillsView, AllPassedUsersView, CTQDefectsAllPlantsView, CompanyLogoViewSet, CurrentMonthDefectsDataView, CurrentMonthTrainingDataView, DaysViewSet, DefectsChartView, DepartmentByFactoryView, DepartmentHierarchyView, EmployeeByCodeView, EmployeeCardDetailsView, EmployeeMasterViewSet, EmployeeReportPDFView, EmployeeViewSet, EvaluationViewSet, FileDownloadView, HQViewSet, FactoryViewSet, DepartmentViewSet, HanContentViewSet, HanTrainingContentByContentID, HanTrainingContentCreateView, HanTrainingContentViewSet, HumanBodyCheckListCreateView, InternalRejectionView, Level2TrainingContentListCreateView, Level2TrainingContentRetrieveUpdateDestroyView, Level3TrainingContentListCreateView, Level3TrainingContentRetrieveUpdateDestroyView, LevelTwoOJTDaysViewSet, LevelTwoOJTScoresViewSet, LevelTwoOJTViewSet, LevelTwoSectionViewSet, LevelTwoSkillTrainingViewSet, LevelTwoSubTopicViewSet, LevelTwoSubUnitViewSet, LevelTwoTopicViewSet, LevelTwoTrainingContentViewSet, LevelTwoTrainingSubunitWiseContentViewSet, LevelTwoUnitViewSet, LineViewSet,
    LevelViewSet, LogoView, MSILDefectsView, MonthPlanViewSet, MonthlySkillViewSet, MultiSkillingViewSet, NestedLevelTwoOJTViewSet, NotificationViewSet, ObservationFailurePointViewSet, ObservationItemViewSet, ObservationResultViewSet, ObservationViewSet, OperationListViewSet, OperationViewSet, OperatorExcelUploadAPIView, OperatorExcelViewSet, OperatorLevelViewSet, OperatorMasterViewSet, OperatorPerformanceEvaluationViewSet, OperatorRemoteAssignmentViewSet, OperatorSkillLevelViewSet, OperatorTestAssignmentViewSet, OperatorsChartView,
...
router.register(r'month-plans', MonthPlanViewSet, basename='monthplan')
...
# urls.py ojt
# --------
router.register(r'leveltwo-trainees', LevelTwoOJTViewSet)
# router.register(r'leveltwo-topics', LevelTwoTrainingTopicViewSet)
router.register(r'leveltwo-days', LevelTwoOJTDaysViewSet)
router.register(r'leveltwo-scores', LevelTwoOJTScoresViewSet)
router.register(r'level2-trainees-score', NestedLevelTwoOJTViewSet, basename='level2-trainee-score')
#-----------OJTnew
